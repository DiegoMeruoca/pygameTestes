...
monitor_size = [pygame.display.Info().current_w, pygame.display.Info().current_h - 60]  # tamanho do monitor menos 60 pixels (Pra barra de titulo)
...
# display = pygame.Surface((854, 480))
display = pygame.Surface((640, 360))  # Cria o Display do game, area visivel do jogo 360 p
# Display com tamanho padronizado que sera escalado para o tamanho do monitor
# Aumentar essa resolução resulta em melhor qualidade da imagem, porem com o jogo muito travado
